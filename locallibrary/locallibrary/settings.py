...
#  SECRET_KEY = 'django-insecure-vhr$a9+dlfm7(zv4lod4+_7k00vp7@ebwjmpp&4mfoav9q6&%h'
...
CSRF_TRUSTED_ORIGINS = ['http://*.127.0.0.1','https://*.railway.app','https://*.127.0.0.1']
